...
function History() {
    const transactions = [
        { id: 135010, date: '12:28 pm, Thu, 28 Dec', details: 'Scheduled garbage pickup at Zone A' },
        { id: 192761, date: '7:02 pm, Mon, 18 Dec', details: 'Scheduled garbage pickup at Zone B' },
        { id: 172826, date: '11:30 am, Sun, 9 Dec', details: 'Cancelled pickup at Zone A' },
    ];
